...
N_aux, lmbd_aux ,X_aux = simulate_aux_sbm(E, final_time,num_nodes1,comm_size1, kernel_function_matrix, kernel_params_matrix, G, labs)
...
N_aux_exp, lmbd_aux_exp ,X_aux_exp  = simulate_aux_sbm(E, final_time,num_nodes2,comm_size2, kernel_function_matrix, kernel_params_matrix, G_exp, labs_exp)
...
save_dir = save_results(
    lmbd_comb, lmbd_comb_exp, lmbd_mf, lmbd_aux, lmbd_aux_exp,
