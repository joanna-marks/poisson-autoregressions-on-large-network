...
def save_results(lmbd_comb, lmbd_comb_exp, lmbd_mf, lmbd_aux, lmbd_aux_exp, T, comm_size1, comm_size2, prob_matrix, kernel_function, kernel_parameters, experiment_name=None):
    ...
    np.save(f"{exp_dir}/lmbd__aux_1000.npy", lmbd_aux)
    np.save(f"{exp_dir}/lmbd_aux_10000.npy", lmbd_aux_exp)
